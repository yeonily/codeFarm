                            ...
                            <div class="title_left_box">
                                <div id="sub_wrap" class="sub_wrap">
                                    <nav id="snb" class="snb">
                                        ...
                                        <div class="lgr_sub">
                                            <ul class="lgr_ul">
                                                <li class="nowMenu"><a href="${pageContext.request.contextPath}/mypage/Apply.my"><span class="checkText">농촌 체험 프로그램</span></a></li>
                                                <li><a href="${pageContext.request.contextPath}/mypage/AlbaOk.my"><span>농촌 아르바이트</span></a></li>
                                            </ul>
                                        </div>
                                    </nav>
                                </div>
                                    ...
                                    <form id="listForm" name="listForm">
                                        <div class="sub01_con inner clearfix">
                                            <div>
                                                ...
                                                <div class="sort_list">
                                                    <button type="button" class="sort_btn" data-id="viewCnt" onclick="test()">조회순</button>
                                            ...
                                            <div class="k_result inner clearfix">
                                                ...
                                                <ul>
                                                        ...
                                                        <li class="program" onclick="location.href='${pageContext.request.contextPath}/program/apply01Ok.pg?programNumber=${program.getProgramNumber()}'">
                                                            ...
                                                            <div class="num">
                                                                <p class="prd">
                                                                	<c:set var = "startDate" value ="${program.getProgramApplyStartDate()}"/>
                                                                	<c:set var = "endDate" value ="${program.getProgramApplyEndDate()}"/>
											...
											<div class="page_nation">
												<c:if test="${prev}">
													<a href="${pageContext.request.contextPath}/mypage/Apply.my?page=1" class="page-num arrow pprev"></a>
													<a href="${pageContext.request.contextPath}/mypage/Apply.my?page=${startPage - 1}" class="page-num arrow prev" ></a>
												</c:if>
												<c:forEach var="i" begin="${startPage}" end="${endPage}">
													<c:choose>
														<c:when test="${not (i eq page)}">
															<a href="${pageContext.request.contextPath}/mypage/Apply.my?page=${i}" class="page-num" >
																<c:out value="${i}"/>
															</a>
														</c:when>
														<c:otherwise>
															<a href="${pageContext.request.contextPath}/mypage/Apply.my?page=${i}" class="page-num active" >
																<c:out value="${i}"/>
															</a>
														</c:otherwise>
													</c:choose>
												...
												<c:if test="${next}">
													<a href="${pageContext.request.contextPath}/mypage/Apply.my?page=${endPage + 1}" class="page-num arrow next"></a>
													<a href="${pageContext.request.contextPath}/mypage/Apply.my?page=${realEndPage}" class="page-num arrow nnext"></a>
												</c:if>
											</div>
										</div>
                                        </form>
