...
public class AlbaApplyMemberOkController implements Execute {
	@Override
...
//		전체 게시글 갯수
		int total = adminDAO.selectIdCounta();
...
//		단위에서 마지막 페이지(1~10)
		...
		req.setAttribute("userList", adminDAO.albaUserSelectAll(pageMap));
