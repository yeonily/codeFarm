package com.farmer.app.localSpeciality;
...
import com.farmer.app.localSpeciality.dao.LocalSpecialityDAO;

public class SearchOkController implements Execute {
	@Override
	public Result execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		HashMap<String, Integer> pageMap = new HashMap<String, Integer>();
		LocalSpecialityDAO lsDAO = new LocalSpecialityDAO();
		Result result = new Result();
		String temp = req.getParameter("page"); 

		int total = lsDAO.selectCount();
...
//		한 페이지에서 나오는 페이지 버튼의 개수
        ...
        req.setAttribute("localProductLists", lsDAO.selectSearch(pageMap));
